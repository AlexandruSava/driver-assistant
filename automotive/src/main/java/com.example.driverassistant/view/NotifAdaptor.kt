...
class NotifAdaptor(private val notifList: MutableList<Notification>, private val onClick: (Notification) -> (Unit)): RecyclerView.Adapter<NotifAdaptor.NotifViewHolder>() {
